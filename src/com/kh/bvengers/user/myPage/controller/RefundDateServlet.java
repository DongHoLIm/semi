...
@WebServlet("/refundDate.mp")
public class RefundDateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public RefundDateServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new MyPageService().getRefundDateCount(memberNo, start, end);
		...
		if(start != null && end != null) {
			...
			ArrayList<myPage> rList = new MyPageService().refundDateList(memberNo, start, end, currentPage, limit);
