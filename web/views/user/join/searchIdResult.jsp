	...
	<div align="center">
		...
		<form action="<%=request.getContextPath()%>/findId.me %>" method="post">
			<div align="center" class="btn1">
  			...
  			<a href="<%=request.getContextPath() %>/views/user/join/searchPwdPage.jsp"> <button type="button" class="btn_search" float="left" id="btn_searchPwd">비밀번호 찾기</button></a>
			</div>
