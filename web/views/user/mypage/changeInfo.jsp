	...
	<form action="<%=request.getContextPath()%>/changeInfo.me" method="post">
		<table class="change_info" style="margin-left:auto; margin-right:auto;">
			<tr>
				...
				<td><input type="text" name="memberId" size=35% value="<%=loginUser.getMemberId()%>" readonly><br></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="memberName" size=35% value="<%=loginUser.getMemberName()%>" readonly></td>
			</tr>
			<tr>
				<td><label>Email</label></td>
				<td><input type="email" name="email" size=35% value="<%=loginUser.getEmail()%>"></td>
			</tr>
			<tr>
				<td><label>연락처</label></td>
				<td><input type="tel" name="phone" size=35% value="<%=loginUser.getPhone()%>"></td>
			</tr>
			<tr>
