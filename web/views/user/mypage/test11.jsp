...
<style>    
            ...
            *{margin:0;padding:0;font-family:"Malgun Gothic","맑은 고딕",Dotum,"돋움",Arial,sans-serif}
            ...
            .btncalendar{display:inline-block;width:22px;height:22px;background:url(<%=request.getContextPath()%>/images/btn_calendar.gif) center center no-repeat;text-indent:-999em}
